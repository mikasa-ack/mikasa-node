...
/// Configure the pallet-mikasa in pallets/template.
impl pallet_mikasa::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		// Include the custom logic from the pallet-mikasa in the runtime.
		Mikasa: pallet_mikasa,
	}
);
